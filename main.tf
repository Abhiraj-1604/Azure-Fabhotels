...
module "aks" {
  ...
  appgw_subnet_id              = module.network.public_subnet_3_id
  appgw_sku_name               = var.appgw_sku_name
  appgw_sku_tier               = var.appgw_sku_tier
  appgw_capacity               = var.appgw_capacity
  appgw_autoscale_enabled      = var.appgw_autoscale_enabled
  appgw_autoscale_min_capacity = var.appgw_autoscale_min_capacity
  appgw_autoscale_max_capacity = var.appgw_autoscale_max_capacity
  appgw_availability_zones     = var.appgw_availability_zones
